...
function restringirApp(idaplicativo) {
    ...
    switch (id) {
        case -1:
            return 1;
 //Restringimos las solicitudes desde el APP ID a las motos con configuraciones en cliente_settings
        default:
            return 0;
    }
};
...
function send(idAplicativo, calback) {
    ...
    switch (id) {
        case _ID_APP_1:
            json = {
                url: _SERVER + 'curiosity/', mail: mail_rover, app: 'Nutriafood', from: 'NutriaFood <NutriafoodOficial@gmail.com>',
                to: 'Nutriafood <NutriafoodOficial@gmail.com>',
                slogan: '😋 Comida exquisita, entregas simples. 🛵 Compra YA! 👇🏻',
                body_bienvanida: 'Mensaje personalizado', head_bienvanida: 'En NutriaFood pide a tu local favorito, o chatea con un asesor por medicina, y te lo llevamos lo antes posible.',
...
var footer =
    ...
    + 'Si usted recibió este correo por error por favor comuniquese con: NutriafoodOficial@gmail.com</p>' +
    '</td>' +
    '</tr>' +
    '<tr>' +
    ...
    + 'Copyright &copy; 2022-2023 <b>HDZCOMPANY</b>, Todos los derechos reservados.</p>' +
    '</td>' +
    '</tr>' +
    '</table>' +
    '</td>' +
